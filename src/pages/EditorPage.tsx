...
import { CodeDrawer } from '../editor/CodeDrawer';
...
export function EditorPage() {
  ...
  return <div className={`editor-shell ${preview ? 'is-preview' : ''}`}>
    ...
    {codeOpen ? <CodeDrawer onClose={() => setCodeOpen(false)}/> : null}
