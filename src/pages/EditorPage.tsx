...
import { PageSettingsModal } from '../editor/PageSettingsModal';
...
export function EditorPage() {
  ...
  return <div className={`editor-shell ${preview ? 'is-preview' : ''}`}>
    ...
    {pageSettingsOpen ? <PageSettingsModal onClose={()=>setPageSettingsOpen(false)}/> : null}
